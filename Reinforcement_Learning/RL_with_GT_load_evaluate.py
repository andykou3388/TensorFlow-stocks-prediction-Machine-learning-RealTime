...
from env.trading_env_GT_luis import TradingEnv_luis
...
print("Configuracion de factores https://es.wikipedia.org/wiki/Q-learning  ")

if __name__ == "__main__":
    print("REMENBER run > Edit configuration > run of side the example ")
    config = get_config()
    print("CONFIG : ", config)
    ...
    # Get all trades
    print("Calculate the trade profits from all trades ")
    trades = eval_env.tried_trades()
