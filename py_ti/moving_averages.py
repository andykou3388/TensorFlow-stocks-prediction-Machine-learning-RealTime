...
from py_ti import check_errors, py_ti
from py_ti.helper_loops import wilders_loop, kama_loop, fib_loop
...
def sma(df, column='Close', n=20, add_col=False, return_struct='numpy'):
    ...
    py_ti.check_errors(df=df, column=column, n=n,
...
def ema(df, column='Close', n=20, add_col=False, return_struct='numpy'):
    ...
    return_struct parameter.
    """
    py_ti.check_errors(df=df, column=column, n=n, add_col=add_col, return_struct=return_struct)
